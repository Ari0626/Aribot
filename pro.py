...
async def on_message(message):
    ...
    if message.content.startwith("ㅇ추방"):
        memeber = message.guild.get_memeber(int(message.content.split(" ")[1]))
        await message.guild.kick(member, reson = ''.join(message.content.split(" "[2])))
   

client.run('ODU2MTc1MDI1MzMyODEzODI0.YM9NIQ.HCLOheT5Xc2bguRdTVs5f6nxD2s')